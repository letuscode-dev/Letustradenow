...
const Interpreter = () => {
    ...
    function initFunc(js_interpreter, scope) {
        ...
        js_interpreter.setProperty(
            pseudo_bot_interface,
            'purchaseOverrideContractType',
            createAsync(js_interpreter, bot_interface.purchaseOverrideContractType)
        );
        js_interpreter.setProperty(
            pseudo_bot_interface,
            'sellAtMarket',
        ...
        if (typeof bot_interface.evaluateDigitPairReturnDiffers === 'function') {
            js_interpreter.setProperty(
                pseudo_bot_interface,
                'evaluateDigitPairReturnDiffers',
                createAsync(js_interpreter, bot_interface.evaluateDigitPairReturnDiffers)
            );
        }
        if (typeof bot_interface.evaluateRecurringPatternDiffer === 'function') {
            js_interpreter.setProperty(
                pseudo_bot_interface,
        ...
        if (typeof bot_interface.evaluateRecurringPatternOver2 === 'function') {
            js_interpreter.setProperty(
                pseudo_bot_interface,
                'evaluateRecurringPatternOver2',
                createAsync(js_interpreter, bot_interface.evaluateRecurringPatternOver2)
            );
        }
        if (typeof bot_interface.replayRecurringPatternOver2 === 'function') {
            js_interpreter.setProperty(
                pseudo_bot_interface,
        ...
        if (typeof bot_interface.evaluateRepeatedDigitRecurrence === 'function') {
            js_interpreter.setProperty(
                pseudo_bot_interface,
                'evaluateRepeatedDigitRecurrence',
                createAsync(js_interpreter, bot_interface.evaluateRepeatedDigitRecurrence)
            );
        }
        if (typeof bot_interface.replayRepeatedDigitRecurrence === 'function') {
            js_interpreter.setProperty(
                pseudo_bot_interface,
        ...
        if (typeof bot_interface.evaluateTripleDigitMartingaleScan === 'function') {
            js_interpreter.setProperty(
                pseudo_bot_interface,
                'evaluateTripleDigitMartingaleScan',
        ...
        if (typeof bot_interface.evaluateDigitPercentageDecrease === 'function') {
            js_interpreter.setProperty(
                ...
                createAsync(js_interpreter, bot_interface.evaluateDigitPercentageDecrease)
            );
        }
