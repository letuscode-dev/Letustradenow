...
window.Blockly.Blocks.adaptive_digit_gap_prediction = {
    ...
    definition() {
        return {
            ...
            tooltip: localize(
                'Tracks an adaptive gap per digit 0–9. Returns the digit to Differs when its current gap reaches its last completed gap, or -1 when none qualify.'
            ),
    ...
    meta() {
        return {
            ...
            description: localize(
                'Independently tracks gaps for digits 0–9. Each digit’s latest completed gap becomes its next Differs trigger. Optional journal and live dashboard logging.'
            ),
