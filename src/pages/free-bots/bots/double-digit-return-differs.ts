  ...
  <block type="trade_definition" id="dd_trade_definition" deletable="false" collapsed="false" x="0" y="60">
            ...
            <next><block type="variables_set" id="dd_init_stop_loss"><field name="VAR" id="dd_stop_loss">Consecutive Loss Stop</field><value name="VALUE"><block type="math_number"><field name="NUM">5</field></block></value>
              <next><block type="variables_set" id="dd_init_window"><field name="VAR" id="dd_window">Analysis Window</field><value name="VALUE"><block type="math_number"><field name="NUM">120</field></block></value>
                <next>${wrapCollapsedAdvancedInit(
                    'dd',
                    `<block type="variables_set" id="dd_init_base_stake"><field name="VAR" id="dd_base_stake">Base Stake</field><value name="VALUE"><block type="variables_get"><field name="VAR" id="dd_stake">Stake</field></block></value>
    ...
    <statement name="SUBMARKET">
      <block type="controls_whileUntil" id="dd_scan_loop" collapsed="true"><field name="MODE">UNTIL</field><value name="BOOL"><block type="logic_operation"><field name="OP">OR</field><value name="A"><block type="variables_get"><field name="VAR" id="dd_signal">Signal</field></block></value><value name="B"><block type="variables_get"><field name="VAR" id="dd_stop">Stop</field></block></value></block></value>
        ...
        </block></statement></block></statement><value name="SECONDS"><block type="variables_get"><field name="VAR" id="dd_cooldown">Cooldown</field></block></value></block></statement>
        <next><block type="controls_if" id="dd_trade_guard"><value name="IF0"><block type="logic_operation"><field name="OP">AND</field><value name="A"><block type="variables_get"><field name="VAR" id="dd_signal">Signal</field></block></value><value name="B"><block type="logic_negate"><value name="BOOL"><block type="variables_get"><field name="VAR" id="dd_stop">Stop</field></block></value></block></value></block></value><statement name="DO0"><block type="trade_definition_tradeoptions" id="dd_options"><mutation xmlns="http://www.w3.org/1999/xhtml" has_first_barrier="false" has_second_barrier="false" has_prediction="true"></mutation><field name="DURATIONTYPE_LIST">t</field><value name="DURATION"><block type="variables_get"><field name="VAR" id="dd_duration">Trade Duration</field></block></value><value name="AMOUNT"><block type="variables_get"><field name="VAR" id="dd_stake">Stake</field></block></value><value name="PREDICTION"><block type="variables_get"><field name="VAR" id="dd_prediction">Target Differ</field></block></value></block></statement></block></next>
      </block>
    </statement>
  </block>
