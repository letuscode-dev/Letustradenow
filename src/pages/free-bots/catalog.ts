...
export const FREE_BOTS: FreeBot[] = [
    ...
    },
    {
        ...
        description:
            'Learns A → B → C → D → E for every digit pattern (0–9), then Differs E when A → B → C → D reappear as the previous four digits before a new tip. Same risk controls as Double Digit → Return Differs, including optional Martingale Off When Profit > Stake.',
