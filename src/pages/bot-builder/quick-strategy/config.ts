...
export const STRATEGIES = (): TStrategies => ({
    ...
    STRATEGY_VOTING: {
        ...
        label: localize('Strategy Voting Differs'),
        rs_strategy_name: 'strategy voting differs',
        description: [
            {
                type: 'text',
                content: [
                    localize(
                        'Runs 18 independent Digit Differs strategies each tick, aggregates weighted votes, and Differs the winning digit only when confidence clears your threshold (default 70%), with no ties and enough voters. Uses Bot #1 payout recovery (default 9.6%). Enable/disable and weight each strategy from the form.'
                    ),
                ],
            },
        ],
        fields: [
            [
                ...
                {
                    type: 'label',
                    label: localize('Confidence threshold %'),
                    description: localize('Minimum confidence required to place a Differs trade. Default 70.'),
                },
                {
                    type: 'number',
                    name: 'confidence_threshold',
                    validation: ['number', 'required', 'floor', { type: 'min', value: '1' }, { type: 'max', value: 100 }],
                },
                {
                    type: 'label',
                    label: localize('Minimum voting strategies'),
                    description: localize('Minimum number of strategies that must cast a vote.'),
                },
                {
                    type: 'number',
                    name: 'min_voting_strategies',
                    validation: ['number', 'required', 'floor', { type: 'min', value: '1' }],
                },
                {
                    type: 'label',
                    label: localize('Maximum abstaining strategies'),
                    description: localize('Reject the signal if more strategies than this abstain.'),
                },
                {
                    type: 'number',
                    name: 'max_abstaining_strategies',
                    validation: ['number', 'required', 'floor', { type: 'min', value: '0' }],
                },
            ],
            [
                LABEL_PAYOUT_PERCENT(),
                ...
                CONSECUTIVE_LOSS(),
                {
                    ...
                    name: 'boolean_strategy',
                    label: localize('Enable strategy'),
                    description: localize('Master on/off for the Strategy Voting Engine.'),
                },
                CHECKBOX_JOURNAL(),
                {
                    type: 'checkbox',
                    name: 'boolean_vote_summary',
                    label: localize('Vote summary journal'),
                    description: localize('Log the full voting summary after each evaluation.'),
                },
                {
                    type: 'checkbox',
                    name: 'boolean_tie_rejection',
                    label: localize('Reject ties'),
                    description: localize('Do not trade when two digits share the highest vote weight.'),
                },
                {
                    type: 'checkbox',
                    name: 'boolean_debug',
                    label: localize('Debug mode'),
                    description: localize('Log strategy evaluation errors to the Journal.'),
                },
                // Strategy enables / weights (ids match strategy-voting-meta.js)
                { type: 'checkbox', name: 'boolean_sv_digit_successor', label: localize('Enable Digit Successor'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_digit_successor', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_complement_digit', label: localize('Enable Complement Digit'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_complement_digit', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_digit_transition', label: localize('Enable Digit Transition'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_digit_transition', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_cold_digit', label: localize('Enable Cold Digit'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_cold_digit', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_least_frequent', label: localize('Enable Least Frequent'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_least_frequent', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_most_frequent', label: localize('Enable Most Frequent'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_most_frequent', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_streak_breaker', label: localize('Enable Streak Breaker'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_streak_breaker', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_last_repeat', label: localize('Enable Last Repeat'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_last_repeat', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_absent_digit', label: localize('Enable Absent Digit'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_absent_digit', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_second_last', label: localize('Enable Second Last'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_second_last', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_parity_fade', label: localize('Enable Parity Fade'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_parity_fade', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_edge_fade', label: localize('Enable Edge Fade'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_edge_fade', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_oscillation', label: localize('Enable Oscillation'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_oscillation', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_mid_range', label: localize('Enable Mid Range'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_mid_range', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_rising_run', label: localize('Enable Rising Run'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_rising_run', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_falling_run', label: localize('Enable Falling Run'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_falling_run', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_unique_tail', label: localize('Enable Unique Tail'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_unique_tail', validation: ['number', 'required', { type: 'min', value: '0' }] },
                { type: 'checkbox', name: 'boolean_sv_modal_neighbor', label: localize('Enable Modal Neighbor'), description: localize('Strategy weight input below.') },
                { type: 'number', name: 'weight_sv_modal_neighbor', validation: ['number', 'required', { type: 'min', value: '0' }] },
            ],
        ],
    },
    D_ALEMBERT: {
